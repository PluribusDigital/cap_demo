...
# This code needs to execute in under 20 seconds, size of DynamoDB Table and Lambda Warm Up time impact this
...
## Role holds a value that is passed as a Parameter from the Contact Flow
    ...
    if len(agent_entry) == 1:
        ...
        ## You can either set a default here for calling a contact or update testReturn as error value
